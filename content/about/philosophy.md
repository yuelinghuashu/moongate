...
description: 从月灵花束到编辑器，一个关于月光与代码的故事
date: 2026-02-24
---
...
月光还在，但不再是“光”，而是一扇**门**。门后是什么？是代码构筑的世界，是极简的科幻终端，是每一个深夜 coding 的人可以进入的领地。
...
Moon Gate 不是“又一个好看的主题”。它的目标是：**让网页拥有编辑器级别的视觉精度**。
...
这不是装饰，这是**机械细节**——让组件看起来像是物理实体，有固定的螺丝，有精确的边界。
...
这不是为了“炫”，而是为了给用户**时间感**——仿佛指令正在被系统处理。
