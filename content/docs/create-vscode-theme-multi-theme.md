...
tags:
  [VSCode, Theme, Dark/Light, Multi-Theme, Design System, Gravity Compensation]
---
...
> - [系统篇：从主题到设计系统：视觉契约与协议](./create-vscode-theme-design-system.md)
...
现在，你的主题已经准备好迎接更广阔的用户群体。下一步，我们将进入**系统篇**，将主题升华为一套完整的设计系统，让它不仅好用，更成为你技术品牌的核心资产。
